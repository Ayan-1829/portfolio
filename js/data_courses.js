/* ================================================================
   ...
   Each course: { code, title, credits, semesters[], emoji, description,
                  topics[], links[], videos[] }

   `semesters` is an ARRAY — list every semester the course was taught,
   e.g. semesters: ["Fall 2025", "Summer 2026"]. Each one renders as its
   own pill. A plain string still works for backwards compatibility.
================================================================ */
    ...
    courses: [
...

      {
        ...
        topics: [
          ...
          { name: "Implementation of Master Slave Flip-Flop with J-K Flip- Flop and verify the truth table for Race Around condition",  links: null, video: null },
          { name: "Design a Decade Counter and verify the truth table",                                                                 links: null,                                                                                                                                video: null },
